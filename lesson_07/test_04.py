...
class Prop:
    ...
    def draw(self):
        raise NotImplementedError('in child class must be draw')
...
class Ellipse(Prop):
    def draw(self):
        print(f'Draw ellipse: {self._sp}, {self._ep}, {self._color}, {self._width}')
...
if __name__ == '__main__':
    ...
    figs.append(Rect(Point(10, 10), Point(20, 10)))
